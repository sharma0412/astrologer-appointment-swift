//
//  ForgotPasswordViewModelClass.swift
//  Zodium
//
...
import Foundation
class ForgotPasswordViewModelClass{
    
    var delegate : ResponseProtocol?
    
    func forgotPasswordApi(param: [String:Any],onSucssesMsg:String){
        LoaderClass.shared.loadAnimation()
        APIClient.postAuth(url: .forgotPassword, parameters: param, method: .post, contentType: .applicationJson, authorizationToken: true) { (response) in
            print(response)
