...
class LoaderClass: UIViewController , NVActivityIndicatorViewable{
    ...
    func loadAnimation() {
        ...
        self.startAnimating(CGSize(width: 60, height: 60), message:"", messageFont: UIFont(name: "Montserrat Regular",size: 12.0), type: .ballSpinFadeLoader, color: #colorLiteral(red: 0.1352918446, green: 0.6063622832, blue: 0.7240642905, alpha: 1), padding: 5, displayTimeThreshold: 5, minimumDisplayTime: 5, backgroundColor: #colorLiteral(red: 1, green: 1, blue: 1, alpha: 0.1425246147), textColor: .darkGray, fadeInAnimation: nil)
    }
