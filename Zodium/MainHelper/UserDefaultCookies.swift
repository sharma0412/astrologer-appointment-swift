...
extension NSDictionary {
    ...
    var e_post_code_ids : Int {
        return self["e_post_code_ids"] as! Int
       }
    var e_job_travel_miles : Int {
           return self["e_job_travel_miles"] as! Int
       }
    var e_carpet_washer : Int {
        return self["e_carpet_washer"] as! Int
    }
    var address : String {
          return self["e_address"] as! String
      }
   var e_created_at : String {
            return self["e_created_at"] as! String
        }
    var e_status : Int {
             return self["e_status"] as! Int
         }
}
